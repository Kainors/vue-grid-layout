...
<div id='app'>
  ...
  <div id='content'>
    ...
    <br/>
    <grid-layout :layout='layout' :col-num='12' :row-height='rowHeight' :is-draggable='draggable' :is-resizable='resizable' :is-mirrored='mirrored'
      :vertical-compact='true' :use-css-transforms='true'>
      <grid-item v-for='item in layout' :key='item.i' :x='item.x' :y='item.y' :w='item.w' :h='item.h' :min-w='2' :min-h='2' :i='item.i'
