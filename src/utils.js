 ...
 * @returns {string}
 */
export function createMarkup (obj: Object) {
 ...
 * @returns {*}
 */
export function addPx (name: string, value: number | string): string {
...
export function findItemInArray (array: Object[], property: string, value: Object): boolean {
...
export function findAndRemove (array: Object[], property: string, value: Object) {
