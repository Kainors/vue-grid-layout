...
export default {
  ...
  methods: {
    createStyle: function () {
      ...
      if (this.isResizing) {
        var minPos = this.calcPosition(this.x, this.y, this.minW, this.minH)
        var maxPos = this.calcPosition(this.x, this.y, this.maxW, this.maxH)
        if (this.resizing.width >= minPos.width && this.resizing.width <= maxPos.width) {
          pos.width = this.resizing.width
        }
        if (this.resizing.height >= minPos.height && this.resizing.height <= maxPos.height) {
